...
// CODE HERE
message["text"]="Solo was a pretty bad movie.";
...
// CODE HERE
var myFriends = ["Dalton", "Nate", "Trevor", "Chris"];
// #6 Add a fifth friends name to the end of your myFriends array

// CODE HERE
myFriends.splice(4,0,"Sam");
...
function friendFinder(obj) {
  if (obj.friend===true)
  return true;
}
var trueFriends = peopleIknow.filter(friendFinder);
...
let indexes = randomNumbers.map(indexFinder => {
  i = 0;
  return ((randomNumbers[i]++) - 1);
});
